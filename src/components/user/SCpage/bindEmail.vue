<template>
  <div>
    ...
    <div class="bind_con">
      <el-form :model="emailInfo" :rules="rule" ref="ruleForm" label-width="100px">
        ...
        <el-form-item label="验证码：" prop="code">
          <el-input v-model="emailInfo.code">
            <el-button v-if="is_send" slot="append" @click.native="getCode">发送验证码</el-button>
      ...
      submitForm(formName) {
        this.$refs[formName].validate(async (valid) => {
          if (valid) {
            let {
              data: result
            } = await this.$http.post("/user/modifyEmail", {
